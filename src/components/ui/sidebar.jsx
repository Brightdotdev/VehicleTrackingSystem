    ...
    if (isMobile) {
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent data-sidebar="sidebar" data-mobile="true" side={side} className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden" style={{ "--sidebar-width": SIDEBAR_WIDTH_MOBILE }}>
...
const SidebarInput = React.forwardRef(({ className, ...props }, ref) => (
  <Input ref={ref} data-sidebar="input" className={cn(
...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => (
  <div ref={ref} data-sidebar="content" className={cn(
...
const SidebarMenuSubButton = React.forwardRef(({ className, isActive, ...props }, ref) => (
  <button ref={ref} data-sidebar="menu-sub-button" data-active={isActive} className={cn(
    "flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:outline-none focus-visible:ring-2 data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground group-data-[collapsible=icon]:hidden",
    className
  )} {...props} />
));
SidebarMenuSubButton.displayName = "SidebarMenuSubButton";

const SidebarMenuSubSkeleton = React.forwardRef(({ className, ...props }, ref) => (
  <Skeleton ref={ref} data-sidebar="menu-sub-skeleton" className={cn(
    "h-7 w-full",
    className
  )} {...props} />
));
SidebarMenuSubSkeleton.displayName = "SidebarMenuSubSkeleton";

const SidebarMenuSeparator = React.forwardRef(({ className, ...props }, ref) => (
  <Separator ref={ref} data-sidebar="menu-separator" className={cn(
    "mx-2 my-1 bg-sidebar-border group-data-[collapsible=icon]:mx-0 group-data-[collapsible=icon]:my-1 group-data-[collapsible=icon]:w-6",
    className
  )} {...props} />
));
