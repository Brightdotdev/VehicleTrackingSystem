...
const Notification = () => {
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    ...
    { id: 2, type: 'Reminder', message: 'Your booking is tomorrow', read: false },
    { id: 3, type: 'Promo', message: 'You’ve unlocked 20% off!', read: false },
    { id: 4, type: 'Update', message: 'We’ve improved our app', read: false },
    { id: 5, type: 'System', message: 'System update complete', read: false },
    { id: 6, type: 'Social', message: 'You have a new follower', read: false },
  ]);
