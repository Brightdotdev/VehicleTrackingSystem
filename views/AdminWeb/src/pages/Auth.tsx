...
export const Auth = (): JSX.Element => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // TODO: Call backend login API and handle auth response here
    // TODO: Validate email and password format
    // TODO: Send login request to backend with email and hashedPassword
    // TODO: Handle authentication response (success/error)
    // TODO: Store auth token in localStorage or secure storage
    // TODO: Handle loading states and error messages
    
    // For now, route to dashboard on successful submit
    navigate('/dashboard');
  };
      ...
      <div className="w-full max-w-[400px] px-4">
        <div className="flex flex-col items-center gap-6">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
            ...
            <button type="submit" className="w-full h-10 bg-black rounded-lg flex items-center justify-center">
              <label
