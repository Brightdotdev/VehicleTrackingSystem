...
import { Cable, CableCar } from 'lucide-react';
...
const Example = ({userName, userLisence, lisenceExp,}: {userName : string , userLisence : string, lisenceExp :string}) => {
...
return (
    ...
    <CreditCardFlipper>
      <CreditCardFront className="bg-[#063573]">
        <CableCar className="absolute top-0 left-0 h-1/12" />
        <CreditCardLogo>
          <CableCar className="text-[#0e72d1]" />
        </CreditCardLogo>
        <CreditCardChip />
