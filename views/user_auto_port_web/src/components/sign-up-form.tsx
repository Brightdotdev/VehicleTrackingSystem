...
import { GoogleLogInButton } from "./utils/UtilComponents"
import { handleAdminLocalSignUp } from "@/lib/handleUserAuth";
import { useRouter } from "next/navigation";
import { useAuth } from "@/contexts/AuthContext";
// Make sure GoogleLogInButton accepts an object prop: { loading: boolean }
...
const TopGoogle = ({ authType }: GoogleButtonProps) =>{
  ...
  return(
            <div className="hidden md:flex-col gap-sm md:flex">
                ...
                <GoogleLogInButton authType={authType} loading={googleLoading} setGoogleLoading={setGoogleLoading} />
