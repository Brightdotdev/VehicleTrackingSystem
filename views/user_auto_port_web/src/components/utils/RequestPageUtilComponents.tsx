...
export const DispatchRequestPageStatusPills = (props: DispatchRequestPageStatusPillsProps) => {
  ...
  const baseClass =
      ...
      if (props.statusName === "AVAILABLE") {
        ...
        return (
          <div
            className={`${baseClass} w-[9rem] bg-gradient-to-r from-yellow-700 to-yellow-600 pl-6 ${
              props.className || ""
            }`}
          >
            <Truck />
...
export const DispatchInfoPagePills = (props: DispatchRequestPageStatusPillsProps) => {
  ...
  const baseClass =
      ...
      if (props.statusName === "AVAILABLE") {
        return (
          <div
            className={`${baseClass} xl:w-[8rem] w-[6rem] bg-gradient-to-r from-yellow-900/40 to-yellow-800/60 pl-4 ${
              props.className || ""
            }`}
          >
            <div className="w-2 h-2 rounded-full bg-white"></div>
        ...
        return (
          <div
            className={`${baseClass} xl:w-[8rem] w-[7rem] bg-gradient-to-r from-green-900/40 to-green-800 pl-4 ${
              props.className || ""
            }`}
          >
            <div className="w-2 h-2 rounded-full bg-white"></div>
        ...
        return (
          <div
            className={`${baseClass} xl:w-[8rem] w-[6rem] bg-gradient-to-r from-teal-900/40 to-teal-800 pl-4 ${
              props.className || ""
            }`}
          >
            <div className="w-2 h-2 rounded-full bg-white"></div>
        ...
        return (
          <div
            className={`${baseClass} w-[9rem] bg-gradient-to-r from-teal-900/40 to-teal-800 pl-4 ${
              props.className || ""
            }`}
          >
            <div className="w-2 h-2 rounded-full bg-white"></div>
