...
export type VehicleInfoPagePropsPills = {
  statusName:
    "CANCELLED"
    |"EXPIRED"
    | "COMPLETED"
...
export const VehicleInfoPageStatusPills = (props: VehicleInfoPagePropsPills) => {
  ...
  const baseClass =
    ...
    return (
      <div
        className={`
          h-[2rem]  lg:w-[10rem]  md:w-[9.5rem] w-[8rem] text-primary-foreground dark:text-foreground 
          bg-gradient-to-r from-green-800  to-green-900
          rounded-full flex items-center justify-start gap-5 pl-4
    ...
    return (
      <div
        className={`
          h-[2rem] w-[12rem]  text-primary-foreground dark:text-foreground 
