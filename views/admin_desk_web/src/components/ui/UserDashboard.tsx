...
import { ArrowUpLeft, Baby,  Timer, X } from "lucide-react"
import { useState } from "react"

import { useTheme } from "@/contexts/ThemeContext"
import UserLicenceCard from "./CreditCardDemo"
import UnvalidatedPage from "../UnvalidatedPage"

export default function UserDashboard({ userData }: { userData: AdminDetails }) {
  ...
  return (
    ...
    Change Theme
          ...
          <footer className="w-full py-8 px-4 text-center bg-background2  md:rounded-md ">
            ...
            <p className="text-xs">
              &copy; {new Date().getFullYear()} Desk Inc. All rights reserved.
            </p>
          </footer>
        </section>
