        ...
        <View style={styles.dispatchBox}>
          ...
          <View style={styles.rowMain}>
            ...
            <View style={styles.row2}>
              <View style={[styles.statusPill, { backgroundColor: "#2F7D32" }]}>
          ...
          <View style={styles.rowMain}>
            <View style={styles.row}>
              <View>
                <Text style={styles.infoText}>Ended in</Text>
              </View>
            </View>
            <View style={styles.row2}>
              <View style={styles.otherSide}>
          ...
          <View style={styles.rowMain}>
            <View style={styles.row}>
              <View>
                <Text style={styles.infoText}>Dispatch Rating</Text>
              </View>
            </View>
            <View style={styles.row2}>
              <View style={styles.otherSide}>
                <Text style={styles.infoText}>My Rating</Text>
              </View>
            </View>
          </View>
        </View>
...
export default CompletedDispatch;
